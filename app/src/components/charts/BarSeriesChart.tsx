...
// Recharts v3 declares dataKey as a branded `TypedDataKey` that resists
// generic string narrowing. Casting through unknown keeps the public API
// of these wrappers type-safe while satisfying the prop type.
    ...
    <div className="w-full" style={{ height }}>
      <ResponsiveContainer>
        <BarChart data={data} margin={{ top: 8, right: 8, bottom: 0, left: 0 }}>
          ...
          />
          <Bar dataKey={dataKey as AnyKey} fill={color} radius={[3, 3, 0, 0]} maxBarSize={14} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
